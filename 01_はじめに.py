...
def main():
    ...
    こちらのWebアプリを作成するにあたって、相性値の研究にご尽力くださった皆様、アプリの改善指摘をくださった皆様にこの場をお借りしてお礼申し上げます。ありがとうございました。  
    """
    ...
    """
	サーバが落ちたり、何か不明点があったりした場合には、[作者X（旧Twitter）](https://twitter.com/sean_lmon "") 、またはオープンチャット等でご連絡ください。  
    ...
    また、S Toolのご利用にあたっては以下の点にご注意ください。  
     1. **相性値について**  
        ...
        ただし、以下の点にご留意ください。  
         - 本ツールで出力される相性値はモンスター同士の素の状態で計算される値です。  
           実際には他に秘伝による上昇値を加味する必要があります。
         - 相性値は、研究先駆者様たちによる血と汗と涙の結晶となりますが、現時点で未解明の部分も存在しており、  
